...
public class Demo {
     ...
     * @throws IOException
     */
    public static String sendSSL(String url, Map<String,String> map, String encoding) throws ParseException, IOException {
        String body = "";
...
//        CloseableHttpClient client = HttpClients.createDefault();
    ...
    public static void main(String[] args){
        ...
        String url = "https://172.16.140.59/api/report/task/65";
        Map<String, String> params = new HashMap<>();
        params.put("username", "admin");
        params.put("password", "nsfocus@123");
        String encoding = "UTF-8";
        try {
            String send = send(url, params, encoding);
